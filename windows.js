...
function makeDraggable (element) {
    ...
    if (element.querySelector('.window-top-no-bind')) {
        // If present, the window-top element is where you move the parent element from
        element.querySelector('.window-top-no-bind').onmousedown = dragMouseDown;
    } 
...
// Add event listeners to bring windows to the front on click
